...
on. Not only did it help me hone in on my technical skills, it also helped me
sharpen my soft skills, such as speaking by giving a code review and
communication by having weekly discussions with classmates. In the program
there were times when I had to collaborate in a team environment through a mock
scrum, where we had to ensure that everyone knew their progress on the project
so that we all collectively met the expectations and deadlines. Another soft
skill I have worked on is being able to break down technical concepts and
...
with each shape having its own textures and material, and with the scene lit by
several different light sources. Enhancement Two focuses on algorithms and data
structures, replacing an unbalanced binary search tree with a self-balancing
AVL tree to help organize courses for advisors to search from a catalog.
Enhancement Three adds an authentication and authorization layer to a
